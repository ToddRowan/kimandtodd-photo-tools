...
function setup_kandt_environment()
{
    ...
    wp_register_script('cycle.lite', plugins_url('js/jquery.cycle.lite.js', __FILE__), array('jquery'));
    ...
    wp_register_script('tosrusjs', plugins_url('js/jquery.tosrus-1.3.1-packed.js', __FILE__), array('hammer','flameportviewscale'));    
